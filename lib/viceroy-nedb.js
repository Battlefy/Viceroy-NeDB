...
/**
 * Viceroy NeDB constructor
 * @constructor
 * @param {Viceroy} viceroy Viceroy ORM instance.
 * @param {Object}  opts    Viceroy NeDB opts.
 */
function ViceroyNeDB(viceroy, opts) {

  // validate
  if(viceroy === null || typeof viceroy != 'object') { throw new Error('viceroy must be an object'); }
  if(opts === null || typeof opts != 'object') { throw new Error('opts must be an object'); }
  if(opts.databasePath && typeof opts.databasePath != 'string') { throw new Error('opts.databasePath must be a string'); }
  ...
  // set viceroy config
  this.viceroy.opts.idKey = '_id';
  this.viceroy.opts.pluralForeignKey = '_{modelName}Ids';
  this.viceroy.opts.singularForeignKey = '_{modelName}Id';
}
 ...
 */
ViceroyNeDB.prototype.connect = function(cb) {
  ...
  var models = this.viceroy.models;
  var collections = this.collections;

  // grab all models registered on viceroy so we
 ...
 * @param  {Function} cb Executed upon completion.
 */
ViceroyNeDB.prototype.close = function(cb) {
 ...
 * @param  {Function} [cb]           Executed upon completion.
 */
ViceroyNeDB.prototype.index = function(collectionName, opts, path, cb) {
 ...
 */
ViceroyNeDB.prototype.count = function(collectionName, opts, query, cout) {
 ...
 */
ViceroyNeDB.prototype.find = function(collectionName, opts, query, rout) {
  var _this = this;
 ...
 * @param  {ModelStream} rout           Records output stream.
 */
ViceroyNeDB.prototype.insert = function(collectionName, opts, rin, rout) {
  var _this = this;
 ...
 * @param  {CountStream} cout           Count stream.
 */
ViceroyNeDB.prototype.update = function(collectionName, opts, query, delta, cout) {
  var _this = this;
 ...
 * @param  {CountStream} cout           Count stream.
 */
ViceroyNeDB.prototype.remove = function(collectionName, opts, query, cout) {
...
/**
 * Convert the Viceroy Query to a NeDB Query object.
 * @private
 * @param  {Query}  query Viceroy Query instance.
 * @return {Object}       NeDB query object.
 */
ViceroyNeDB.prototype._convertQuery = function(query) {
...
/**
 * Convert the Viceroy Delta to a NeDB Delta object.
 * @private
 * @param  {Query}  delta Viceroy Delta instance.
 * @return {Object}       NeDB delta object.
 */
ViceroyNeDB.prototype._convertDelta = function(delta) {
...
ViceroyNeDB.prototype._convertSort = function(sort) {
  var ns = null;
 ...
 */
ViceroyNeDB.prototype._pipeOutRecords = function(records, offset, limit, rout) {
